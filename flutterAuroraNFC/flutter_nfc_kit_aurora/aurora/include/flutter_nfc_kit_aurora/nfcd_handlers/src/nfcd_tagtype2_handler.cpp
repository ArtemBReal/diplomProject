...
QString NfcdTagType2HandlerPrivate::readAllData(){
    return m_iface.isNull() ? QString() : m_iface->ReadAllData().value();
}

QString NfcdTagType2HandlerPrivate::serial(){
    return m_iface.isNull() ? QString() : m_iface->GetSerial().value();
}
...
QString NfcdTagType2Handler::readAllData(){
    return m_data->readAllData();
}

QString NfcdTagType2Handler::serial(){
